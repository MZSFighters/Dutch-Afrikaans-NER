...
wandb.init(project="NLP_Project", name="NER-oneline-30e-b16-2e-5")
...
tokenizer = AutoTokenizer.from_pretrained('Wiki_Oneline', do_lower_case=True)
model = AutoModelForTokenClassification.from_pretrained('Wiki_Oneline', 
...
model.save_pretrained("./ner_wiki_oneline")
tokenizer.save_pretrained("./ner_wiki_oneline")
