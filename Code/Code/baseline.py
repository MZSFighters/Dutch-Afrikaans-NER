...
wandb.init(project="NLP_Project", name="NER-baseline-30e-b16-2e-5")
...
model = AutoModelForTokenClassification.from_pretrained('GroNLP/bert-base-dutch-cased', 
...
model.save_pretrained("./fine_tuned_ner_model_baseline")
tokenizer.save_pretrained("./fine_tuned_ner_model_baseline")
