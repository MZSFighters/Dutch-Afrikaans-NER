...
class MaskedLanguageModelingDataset(Dataset):
    ...
    def create_examples(self, text):
        ...
        # splitting the sentence into chunks using the newline character
        chunks = text.split('\n')
        
        # combining the short chunks and splitting the long ones
        processed_chunks = []
        current_chunk = ""
        for chunk in chunks:
...
def main():
    wandb.init(project="NLP_Project", name="dutch-bert-mlm-30e-16b-2e5")
    ...
    # loading the corpus
    file_path = './afrikaans_wikipedia.txt'
    try:
